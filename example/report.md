...
**Report ID**: `cce4eb4d-40e6-4a34-9fec-e13817b4a7f6`

**Cluster**: cluster-1

**Generated At**: 2026-02-07 06:30:36 UTC
...
|------|-------------|------------|----------------|--------|
| master01 | Red Hat Enterprise Linux 9.7 (Plow) | 192.168.22.151 | 5.14.0-611.24.1.el9_7.x86_64 | 3 day(s) 23 hour(s) |
| worker01 | Red Hat Enterprise Linux 9.7 (Plow) | 192.168.22.152 | 5.14.0-611.24.1.el9_7.x86_64 | 3 day(s) 23 hour(s) |
| worker02 | Red Hat Enterprise Linux 9.7 (Plow) | 192.168.22.153 | 5.14.0-611.24.1.el9_7.x86_64 | 3 day(s) 23 hour(s) |
| worker03 | Red Hat Enterprise Linux 9.7 (Plow) | 192.168.22.154 | 5.14.0-611.24.1.el9_7.x86_64 | 3 day(s) 23 hour(s) |

### Node resources

| Node | CPU (cores) | CPU Used | CPU % | Mem Total (Gi) | Mem Used (Gi) | Mem % | Swap Total (Gi) | Swap Used (Gi) | Swap % | Load (1m, 5m, 15m) |
|------|-------------|----------|-------|----------------|---------------|-------|----------------|---------------|-------|---------------------|
| master01 | 4 | 0.42 | 10.6% | 7.5 | 2.8 | 36.9% | 0.00 | 0.00 | 0.0% | 0.47, 0.33, 0.35 |
| worker01 | 32 | 0.13 | 0.4% | 31.1 | 14.3 | 46.0% | 0.00 | 0.00 | 0.0% | 0.19, 0.20, 0.13 |
| worker02 | 12 | 0.06 | 0.5% | 23.2 | 2.7 | 11.8% | 0.00 | 0.00 | 0.0% | 0.07, 0.15, 0.08 |
| worker03 | 16 | 0.22 | 1.4% | 23.2 | 4.5 | 19.6% | 0.00 | 0.00 | 0.0% | 0.00, 0.07, 0.14 |
...
| worker01 | / | overlay | - | 58.4 | 22.2 | 38.1% | Info |
| worker01 | /etc | /dev/mapper/rhel-root | - | 58.4 | 22.2 | 38.1% | Info |
| worker02 | /host/boot | /dev/sda2 | - | 0.9 | 0.4 | 46.7% | Info |
| worker02 | /etc | /dev/mapper/rhel-root | - | 58.4 | 12.5 | 21.3% | Info |
| worker02 | / | overlay | - | 58.4 | 12.5 | 21.3% | Info |
| worker03 | /host/boot | /dev/sda2 | - | 0.9 | 0.4 | 46.7% | Info |
| worker03 | /etc | /dev/mapper/rhel-root | - | 58.4 | 13.7 | 23.5% | Info |
| worker03 | / | overlay | - | 58.4 | 13.7 | 23.5% | Info |
...
|------|------|---------|-----------------|----------------|
| master01 | /etc/kubernetes/ssl/apiserver-kubelet-client.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| master01 | /etc/kubernetes/ssl/apiserver.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| master01 | /etc/kubernetes/ssl/ca.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| master01 | /etc/kubernetes/ssl/front-proxy-ca.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| master01 | /etc/kubernetes/ssl/front-proxy-client.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| worker01 | /etc/kubernetes/ssl/ca.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| worker02 | /etc/kubernetes/ssl/ca.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |
| worker03 | /etc/kubernetes/ssl/ca.crt | No | Jan  2 04:05:42 2126 GMT | 36487 |

## Recent cluster events (Warning / Error)

| Namespace | Object | Level | Reason | Message | Last seen |
|-----------|--------|-------|--------|---------|----------|
| upm-system | Pod/consul-connect-injector-6b4b944cd5-jwhpg | Warning | BackOff | Back-off restarting failed container sidecar-injector in ... | 2026-02-07 06:28:30 |
| default | Pod/nginx-deployment-fail-5cff74b894-jsls4 | Warning | Failed | Error: ImagePullBackOff | 2026-02-07 06:28:03 |
| default | Pod/nginx-deployment-fail-5cff74b894-nwdvc | Warning | Failed | Error: ImagePullBackOff | 2026-02-07 06:28:03 |
| upm-system | Pod/consul-connect-injector-69b8cc47c5-ssqhv | Warning | BackOff | Back-off restarting failed container sidecar-injector in ... | 2026-02-07 06:27:40 |
| upm-system | Pod/consul-connect-injector-6b4b944cd5-jwhpg | Warning | Unhealthy | Startup probe failed: Get "http://10.233.69.134:9445/read... | 2026-02-07 06:23:49 |
| upm-system | Pod/consul-connect-injector-69b8cc47c5-ssqhv | Warning | Unhealthy | Startup probe failed: Get "http://10.233.94.112:9445/read... | 2026-02-07 06:22:58 |
| default | Pod/nginx-deployment-fail-5cff74b894-jsls4 | Warning | Failed | Failed to pull image "nginx:non-existent-tag": rpc error:... | 2026-02-07 06:03:20 |
| default | Pod/nginx-deployment-fail-5cff74b894-nwdvc | Warning | Failed | Failed to pull image "nginx:non-existent-tag": rpc error:... | 2026-02-07 05:38:21 |
...
| `upm-system/consul-connect-injector-6b4b944cd5-jwhpg` | Critical | [POD-007](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-007.md) | CrashLoopBackOff |
...
| `velero/upm-system-minio-backups-kopia-maintain-job-1770434977894-cv6pk` | Warning | [RES-001](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-001.md) | Container has no resource requests |
| `velero/upm-system-minio-backups-kopia-maintain-job-1770438877903-686vz` | Warning | [RES-001](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-001.md) | Container has no resource requests |
| `velero/upm-system-minio-backups-kopia-maintain-job-1770442777911-4wtcg` | Warning | [RES-001](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-001.md) | Container has no resource requests |
...
| `velero/upm-system-minio-backups-kopia-maintain-job-1770434977894-cv6pk` | Warning | [RES-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-002.md) | Container has no resource limits |
| `velero/upm-system-minio-backups-kopia-maintain-job-1770438877903-686vz` | Warning | [RES-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-002.md) | Container has no resource limits |
| `velero/upm-system-minio-backups-kopia-maintain-job-1770442777911-4wtcg` | Warning | [RES-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-002.md) | Container has no resource limits |
...
| `upm-system/upm-platform-auth-7cb945f67d-hvl9m` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-elasticsearch-ms-6bdff4b79b-2jwm9` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-innodb-cluster-ms-5fb56d898b-sh7xq` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-kafka-ms-77c4ccd4d6-66kjt` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-milvus-ms-68f994794f-thjjm` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-mongodb-ms-6c5c6ffc4-hbr2c` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-mysql-ms-598d6cf7db-9w42l` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-postgresql-ms-65676ffccc-sz27w` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
...
| `upm-system/upm-platform-redis-ms-5d4bf984f-pr2rs` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-resource-78d8494fdb-kmlvs` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
| `upm-system/upm-platform-zookeeper-ms-668877c9f8-zprtm` | Warning | [POD-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/POD-003.md) | Container restart count too high |
...
| `kubeowler/kubeowler-node-inspector-58vk2` | Warning | [SEC-009](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-009.md) | Uses default ServiceAccount |
| `kubeowler/kubeowler-node-inspector-l5cb2` | Warning | [SEC-009](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-009.md) | Uses default ServiceAccount |
| `kubeowler/kubeowler-node-inspector-lq67c` | Warning | [SEC-009](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-009.md) | Uses default ServiceAccount |
| `kubeowler/kubeowler-node-inspector-qpr5h` | Warning | [SEC-009](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-009.md) | Uses default ServiceAccount |
...
|--------------------------|-----------------------|--------------|-------------------|-------|------------|
| demo/demo-cm-ss-root-ca | CN=demo | Feb  3 09:06:59 2027 +00:00 | 361 | Info | [CERT-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/CERT-002.md) |
| upm-system/consul-connect-inject-webhook-cert | CN=Consul Webhook Certificates Service | Feb  8 00:06:35 2026 +00:00 | 0 | Warning | [CERT-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/CERT-002.md) |
| upm-system/consul-server-cert | CN=server.upm.consul | Feb  2 09:34:47 2028 +00:00 | 725 | Info | [CERT-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/CERT-002.md) |
| upm-system/upm-engine-compose-operator-webhook-server-certs |  | May  3 08:51:37 2026 +00:00 | 85 | Info | [CERT-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/CERT-002.md) |
| upm-system/upm-engine-unit-operator-webhook-server-certs |  | May  3 08:51:16 2026 +00:00 | 85 | Info | [CERT-002](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/CERT-002.md) |
...
| `kubeowler/kubeowler-node-inspector-58vk2` | Warning | [SEC-006](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-006.md) | Container runs as root |
| `kubeowler/kubeowler-node-inspector-l5cb2` | Warning | [SEC-006](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-006.md) | Container runs as root |
| `kubeowler/kubeowler-node-inspector-lq67c` | Warning | [SEC-006](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-006.md) | Container runs as root |
| `kubeowler/kubeowler-node-inspector-qpr5h` | Warning | [SEC-006](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/SEC-006.md) | Container runs as root |
...
| `demo` | Warning | [RES-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-003.md) | Namespace has no resource quota |
| `kubeowler` | Warning | [RES-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-003.md) | Namespace has no resource quota |
...
| `upm-system` | Warning | [RES-003](https://github.com/Ghostwritten/kubeowler/blob/main/docs/issues/RES-003.md) | Namespace has no resource quota |
